...
try{
	...
	$lead = $api_connector->create(array(
		'name'			=> $_POST['name'],
		'phone'			=> $_POST['phone'],
		'offer_id'		=> '1512',                         // offer_id из ЛК
		'stream_id'		=> '87396',                         // Optional, stream_id 
		'country' 		=> 'SK',                            // Country in format https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2
		'tz' 			=> '',
		'address' 		=> '',
...
{
    public $config = array(
        'api_key' => '56df1e0013c89ca2a808f27f2ed2ea87',                                     		// api_key of user
        'user_id' =>  '24446',                                                              		// user_id
